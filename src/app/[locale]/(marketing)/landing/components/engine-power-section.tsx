...
export function EnginePowerSection() {
  ...
  return (
    <motion.section
      className="relative min-h-svh overflow-hidden px-6 py-14 md:px-10 md:py-20"
      initial="hidden"
      whileInView="visible"
    ...
    >
      ...
      <motion.div
        className="relative z-10 mx-auto flex min-h-svh w-full max-w-7xl flex-col justify-center"
      ...
      >
        ...
        <motion.div
          className="mt-14 grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center"
          variants={containerVariants}
        >
          <motion.div
          ...
          >
            ...
            <motion.div className="relative z-10" variants={containerVariants}>
              ...
              <motion.p className="mt-5 max-w-md text-2xl leading-tight text-foreground md:text-[2rem]" variants={itemVariants}>
              ...
              <motion.div className="mt-7 space-y-3" variants={containerVariants}>
                {ENGINE_ITEMS.map((item, index) => (
                  ...
                  >
                    <h3 className="text-lg font-semibold leading-tight text-foreground">{t(item.titleKey)}</h3>
                    <p className="mt-2 text-sm leading-6 text-foreground/80">{t(item.descriptionKey)}</p>
                  </motion.article>
                ))}
              </motion.div>
            </motion.div>
