...
import { NavidShowcaseBackground } from "@/components/landing/navid-showcase-background"
...
export function NavidLandingHeroBackground({ className }: { className?: string }) {
  return <NavidShowcaseBackground className={className} />
}
